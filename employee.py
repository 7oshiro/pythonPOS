...
class employeeClass:
    def __init__(self, root):
        ...
        btn_search=Button(SearchFrame, text="Search", command=self.search, font=("goudy old style",15), bg="black", fg="white", cursor="hand2").place(x=410,y=9, width=150, height=30)
        
        
        #=====title===
        title=Label(self.root, text="Employee Details", font=("goudy old style", 15), bg="black", fg="white").place(x=50, y=100, width=1000)
